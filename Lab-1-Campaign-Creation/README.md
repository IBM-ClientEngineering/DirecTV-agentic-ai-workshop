...
2. **Email Generation Agent**
   ...
   | **AI Model (IBM watsonx.ai)**    | Email content is generated by Llama 3.3 70B running on IBM watsonx.ai. If the AI fails to produce a valid response for any reason, the system falls back to a safe, pre-approved template so the campaign is never blocked                                                                              |
...
**Example 2: Drama Viewers Upgrade**
...
**Example 3: Premium Drama in LA**

```
Target PREMIER subscribers in Los Angeles who love Drama. Generate a Hollywood-cinematic marketing email highlighting our premium content library.
```

**Example 4: Documentary & Science Fans**
...
**Example 5: Summer Kids Programming**
